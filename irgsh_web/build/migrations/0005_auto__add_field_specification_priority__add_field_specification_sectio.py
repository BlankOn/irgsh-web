...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Specification.priority'
        db.add_column('build_specification', 'priority', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True), keep_default=False)

        # Adding field 'Specification.section'
        db.add_column('build_specification', 'section', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Specification.priority'
        db.delete_column('build_specification', 'priority')

        # Deleting field 'Specification.section'
        db.delete_column('build_specification', 'section')
    ...
    models = {
        ...
        'build.extraorig': {
            'Meta': {'object_name': 'ExtraOrig'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orig': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'specification': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['build.Specification']"})
        },
        'build.package': {
        ...
        'build.specification': {
            ...
            'priority': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
            'section': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
