...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # From http://stackoverflow.com/questions/1742021/adding-new-custom-permissions-in-django#answer-6149593
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='specification', app_label='build')
        perm, created = orm['auth.permission'].objects.get_or_create(content_type=ct, codename='specification_submit')
        if created:
            perm.name = u'Can submit a new job'
            perm.save()
