...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtraOrig'
        db.create_table('build_extraorig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('specification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['build.Specification'])),
            ('orig', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('build', ['ExtraOrig'])


    def backwards(self, orm):
        
        # Deleting model 'ExtraOrig'
        db.delete_table('build_extraorig')
